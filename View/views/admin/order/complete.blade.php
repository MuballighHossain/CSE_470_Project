...
<div class="col">
    <div class="text-right ">
        @isset($countTotal)
        <p class="text-muted d-inline">Completed Orders: <span class="badge badge-info z-depth-0" style="font-size: 16px;"> {{$countTotal}}</span></p>
        @endisset
    </div>
</div>
</div>
